...
df_point_SDD_path = Path('./support_data/SDD_interpolated_2000_2018_Inputs.csv')
df_linkage_path = Path('./support_data/Watershed_linkage.xlsx')
df_linkage2_path = Path('./support_data/Watershed_linkage_v2.xlsx')
df_landuse_path = Path('./support_data/landuse.xlsx')
df_pd_coef_poly_path = Path('./support_data/sediment_streamflow_regression_coefs.xlsx')
xls_path = Path('./100Randomizations/100RandomizeHRUstorePercentage_4BMPs.xlsx')
...
df_pd_coef_poly_sed = pd.read_excel(df_pd_coef_poly_path, sheet_name='poly', usecols='B:D')
